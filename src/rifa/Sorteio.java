...
public class Sorteio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setForeground(new java.awt.Color(12, 231, 236));
        ...
        jLabel3.setText("Digite a Quantidade de numeros para o sorteio:");
        ...
        jLabel1.getAccessibleContext().setAccessibleName("ate");
...
int numerox = Integer.parseInt(n);
 int NumeroSorteado = aleatorio.nextInt(numerox)+1;
JOptionPane.showMessageDialog(null,"O numero Sorteado Foi :"+NumeroSorteado+"!");
